...
const TitleSection = ({
  ...
  return (
    <>
      <div className="flex justify-between border-b border-gray-100 pb-5 md:pb-6 lg:border-0 lg:pb-7.5">
        ...
        {isOwner && (
          <Dropdown options={options}>
            {({ toggle }) => (
              <More className="h-7 w-7 cursor-pointer" onClick={toggle} />
            )}
          </Dropdown>
        )}
      </div>
