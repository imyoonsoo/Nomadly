...
const SIZE_CLASSES = {
  sm: "min-w-80 min-h-[140px] rounded-6 p-[30px] md:min-w-100 md:min-h-[170px] md:rounded-[30px] md:p-10",
  md: "w-80 min-h-[185px] rounded-6 p-[30px] pb-6 md:w-100 md:min-h-[242px] md:rounded-[30px] md:p-[30px]",
